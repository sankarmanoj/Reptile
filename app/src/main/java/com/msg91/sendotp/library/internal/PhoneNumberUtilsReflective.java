...
public class PhoneNumberUtilsReflective {
  ...
  public static void setFormatterCountryIso(PhoneNumberFormattingTextWatcher textWatcher, String formatter) {
    ...
    } catch (VerificationReflectionException var4) {
  ...
  public static String numberInE164Format(String phoneNumber, String countryIso) {
    ...
    } catch (VerificationReflectionException var7) {
  ...
  private static Object parsePhoneNumber(String number, String countryIso) {
    ...
    } catch (VerificationReflectionException var5) {
  ...
  private static Object invokeMethod(Method ret, Object instance, Object... params) throws VerificationReflectionException {
    try {
      Object ret1 = ret.invoke(instance, params);
      return ret1;
    } catch (IllegalAccessException var3) {
      throw new VerificationReflectionException(var3);
    } catch (InvocationTargetException var4) {
      throw new VerificationReflectionException(var4.getTargetException());
    }
  }

  private static Method getMethod(Class method, String methodName, Class... params) throws VerificationReflectionException {
    try {
  ...
  private static Class getClass(String clazz) throws VerificationReflectionException {
    try {
      Class clazz1 = Class.forName(clazz);
      return clazz1;
    } catch (ClassNotFoundException var1) {
      throw new VerificationReflectionException(var1);
    }
  }

  private static Field getField(Class field, String fieldName) throws VerificationReflectionException {
    try {
      Field field1 = field.getDeclaredField(fieldName);
      return field1;
    } catch (NoSuchFieldException var2) {
      throw new VerificationReflectionException(var2);
    }
  }

  private static void setField(Object e, Field field, Object value) throws VerificationReflectionException {
